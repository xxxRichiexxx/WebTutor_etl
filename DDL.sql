...
CREATE TABLE sttgaz.dds_webtutor_subdivision(
    ...
    tel VARCHAR(500),
    street VARCHAR(1000),
    id_stoyanki_ISC VARCHAR(500),
    f_20u4 VARCHAR(500),
    id_plowadki_ISC VARCHAR(500),
    email VARCHAR(500),
    gps VARCHAR(500),
    id_skidki VARCHAR(500),
    id_doc_obor VARCHAR(500),
    f_4xwo VARCHAR(500),
    id_f_nliz_MDAUDIT VARCHAR(500),
    f_so4s_MDAUDIT VARCHAR(500),
    f_postpril1 VARCHAR(500),
    f_dilerskidki VARCHAR(500)
);
