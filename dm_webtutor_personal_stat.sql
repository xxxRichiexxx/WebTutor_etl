...
SELECT
	...
	"МП. План предыдущий месяц" +
	"ЭКорп. План предыдущий месяц" + 
	"РОП. План предыдущий месяц"																							AS "Торг. персонала всего. План. Предыдущий месяц",
	...
	CASE
		WHEN "МП. Факт предыдущий месяц" + 
			...
			"МП. План предыдущий месяц" > 0 THEN 0
	...
	CASE
		WHEN "ЭКорп. Факт предыдущий месяц" - "ЭКорп. План предыдущий месяц" > 0 THEN 0
		ELSE "ЭКорп. Факт предыдущий месяц" - "ЭКорп. План предыдущий месяц"
	...
	CASE
		WHEN "РОП. Факт предыдущий месяц" - "РОП. План предыдущий месяц" > 0 THEN 0
		ELSE "РОП. Факт предыдущий месяц" - "РОП. План предыдущий месяц"
	END 																													AS "Нехватка РОП. Предыдущий месяц",

	"Нехватка МП" + "Нехватка ЭКорП" + "Нехватка РОП" 																		AS "Нехватка всего",

	"Нехватка МП. Предыдущий месяц" + "Нехватка ЭКорП. Предыдущий месяц" + "Нехватка РОП. Предыдущий месяц"					AS "Нехватка всего. Предыдущий месяц"
FROM dm_prepare;