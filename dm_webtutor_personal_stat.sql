...
WITH
	...
	SELECT
		*,
		CASE
			WHEN "Менеджер по продажам новых автомобилей (МП). План" + 
				"Эксперт по корпоративным продажам (ЭКорП). План" + 
				"Руководитель отдела продаж (РОП). План" - 
				("МП. Факт" + "СтМОП. Факт" + "ЭКорП. Факт" + "РОП. Факт") > 0 THEN 1
			ELSE 0
		END 																													AS "Нехватка персонала в текущем месяце (да/нет)",
		CASE
			WHEN "МП. План предыдущий месяц" + 
				"ЭКорп. План предыдущий месяц" + 
				"РОП. План предыдущий месяц" - 
				("МП. Факт предыдущий месяц" + "СтМОП. Факт предыдущий месяц" + "ЭКорп. Факт предыдущий месяц" + "РОП. Факт предыдущий месяц") > 0 THEN 1
			ELSE 0
